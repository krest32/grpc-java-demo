...
public final class HelloWorldGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.krest.grpc.Greeting,
      com.krest.grpc.HelloResp> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.krest.grpc.Greeting.class,
      responseType = com.krest.grpc.HelloResp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.krest.grpc.Greeting,
      com.krest.grpc.HelloResp> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.krest.grpc.Greeting, com.krest.grpc.HelloResp> getSayHelloMethod;
      ...
      synchronized (HelloWorldGrpc.class) {
        if ((getSayHelloMethod = HelloWorldGrpc.getSayHelloMethod) == null) {
          HelloWorldGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.krest.grpc.Greeting, com.krest.grpc.HelloResp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "HelloWorld", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.krest.grpc.Greeting.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.krest.grpc.HelloResp.getDefaultInstance()))
  ...
  public static abstract class HelloWorldImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.krest.grpc.Greeting request,
        io.grpc.stub.StreamObserver<com.krest.grpc.HelloResp> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.krest.grpc.Greeting,
                com.krest.grpc.HelloResp>(
  ...
  public static final class HelloWorldBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldBlockingStub> {
    ...
    /**
     */
    public com.krest.grpc.HelloResp sayHello(com.krest.grpc.Greeting request) {
  ...
  public static final class HelloWorldFutureStub extends io.grpc.stub.AbstractStub<HelloWorldFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.krest.grpc.HelloResp> sayHello(
        com.krest.grpc.Greeting request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.krest.grpc.Greeting) request,
              (io.grpc.stub.StreamObserver<com.krest.grpc.HelloResp>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.krest.grpc.HelloWorldProto.getDescriptor();
    }
